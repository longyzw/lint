...
const generateLintConfigs = () => {
  ...
  lintTarget.forEach(item => {
    ...
    const fileName = isCommitLint ? 'commitlint.config.cjs' : `.${item}rc.cjs`
...
const generateVscodeExtensions = () => {
  ...
  const extensionsContent = {
    recommendations: ['Vue.volar', 'dbaeumer.vscode-eslint', 'esbenp.prettier-vscode', 'stylelint.vscode-stylelint']
  }
